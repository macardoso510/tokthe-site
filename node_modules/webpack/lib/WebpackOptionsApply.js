...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/mateus-cardoso/.vscode/extensions/wallabyjs.console-ninja-1.0.462/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209abaa51580bfc9f37f6eDE9TUVAbAQ9ZU1IAAVtfVlUEBQQN', mode: 'build'}); } catch(cjsError) { try { import('file:///home/mateus-cardoso/.vscode/extensions/wallabyjs.console-ninja-1.0.462/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209abaa51580bfc9f37f6eDE9TUVAbAQ9ZU1IAAVtfVlUEBQQN', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
